...
/*///////////////////////////////////////////////////////////////
 ...
 ///////////////////////////////////////////////////////////////*/
/**
 * ID: Kecik Framework - Micro Framework
 * EN: Kecik Framework - The Micro Framework
 *
...
/**
 * This is a main class for handle Assets, Config, MVC, Request Url and libraries
 * @package Kecik
 */
class Kecik {
				...
				if ( class_exists( $ClsLibrary ) ) {
					...
					if ( isset( $params['enable'] ) && $params['enable'] === TRUE ) {
						...
						if ( ! isset( $params['config'] ) && ! isset( $params['params'] ) ) {
							...
							/**
							 * ID: Buat variabel config | EN: Create config variable
							 */
	...
	/**
	 * Get the instance of 'Kecik' Class
	 *
	 * @return Kecik|null
	 */
	...
	/**
	 * Set route for Post Method request
	 *
	 * @return $this
	 */
	...
	/**
	 * Set route for Put Method request
	 *
	 * @return $this
	 */
	public function put() {
	...
	/**
	 * Set route for Delete Method request
	 *
	 * @return $this
	 */
	...
	/**
	 * Set route for Patch Method request
	 *
	 * @return $this
	 */
	...
	/**
	 * Set route for options Method request
	 *
	 * @return $this
	 */
		...
		if ( self::$FullRender != '' ) {
			...
			if ( is_callable( $this->callable ) ) {
				...
				if ( count( self::$header ) > 0 && php_sapi_name() != 'cli' ) {
					...
					foreach ( self::$header as $headerValue ) {
						header( $headerValue );
					}
	...
	/**
	 * Get the library is already loaded
	 *
	 * @return array
	 */
